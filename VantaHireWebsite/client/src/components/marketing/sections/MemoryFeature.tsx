      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "5rem", alignItems: "center" }}>
        ...
        >
          ...
          <p style={{ fontFamily: "var(--font-body)", fontSize: "0.97rem", color: "#8891AA", lineHeight: 1.8, marginBottom: "2rem" }}>
            Every candidate your team finds, every interview note, every &quot;not right now&quot; — ealana stores it all and connects the dots. When the right role opens months later, the right person resurfaces automatically. No knowledge walks out the door when someone leaves.
          </p>
