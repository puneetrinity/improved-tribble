...
const sections: LegalSection[] = [
  {
    ...
    content: (
      <>
        <p>
          VantaHire, a brand of <a href="https://www.airevolabs.com" target="_blank" rel="noopener noreferrer" className="hr-legal-link">Airevolabs LLP</a> ("we," "our," or "us"),
    ...
    content: (
      <>
        <div className="hr-legal-subsection">
          <h4 className="hr-legal-h4">Personal Information</h4>
        ...
        <div className="hr-legal-subsection">
          <h4 className="hr-legal-h4">Automatically Collected Information</h4>
          <ul className="hr-legal-list">
        ...
        <div className="hr-legal-subsection">
          <h4 className="hr-legal-h4">AI-Generated Data</h4>
          <p>
  ...
  },
  {
    ...
    content: (
      <>
        <div className="hr-legal-subsection">
          <h4 className="hr-legal-h4">With Recruiters and Employers</h4>
          <p>
        ...
        <div className="hr-legal-subsection">
          <h4 className="hr-legal-h4">Service Providers</h4>
        ...
        <div className="hr-legal-subsection">
          <h4 className="hr-legal-h4">Legal Requirements</h4>
          <p>
            We may disclose your information if required by law, court order, or government request,
            or to protect our rights, property, or safety.
          </p>
        </div>
        <div className="hr-legal-highlight-box hr-legal-highlight-box--green">
          <Lock size={14} />
    ...
    content: (
      <>
        <p>
          ...
          <a href="/cookie-policy" className="hr-legal-link">Cookie Policy</a>.
        </p>
        <p>
    ...
    content: (
      <>
        ...
        <div className="hr-legal-contact-card">
          ...
          <div className="hr-legal-contact-subject">Subject: Privacy Policy Inquiry</div>
        </div>
      </>
    ),
  },
